...
# ---------------------------------------------------------------------------- 
#set_property -dict {PACKAGE_PIN W11 IOSTANDARD LVCMOS33} [get_ports {MOT_Z_PWM}];  # Motor PWM
#set_property -dict {PACKAGE_PIN W12 IOSTANDARD LVCMOS33} [get_ports {MOT_Z_OTF}];  # Overtemperature Flag
#set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS33} [get_ports {MOT_Z_DIR}];   # Direction Signal
#set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {MOT_Z_BRK}];  # Brake Signal
...
# ---------------------------------------------------------------------------- 
#set_property -dict {PACKAGE_PIN AB6 IOSTANDARD LVCMOS33} [get_ports {MOT_Y_PWM}];  # Motor PWM
#set_property -dict {PACKAGE_PIN AB7 IOSTANDARD LVCMOS33} [get_ports {MOT_Y_OTF}];  # Overtemperature Flag
#set_property -dict {PACKAGE_PIN AA4 IOSTANDARD LVCMOS33} [get_ports {MOT_Y_DIR}];  # Direction Signal
#set_property -dict {PACKAGE_PIN Y4 IOSTANDARD LVCMOS33}  [get_ports {MOT_Y_BRK}];  # Brake Signal
...
# ---------------------------------------------------------------------------- 
#set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports {MOT_X_PWM}];  # Motor PWM
#set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33} [get_ports {MOT_X_OTF}];  # Overtemperature Flag
#set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVCMOS33} [get_ports {MOT_X_DIR}];  # Direction Signal
#set_property -dict {PACKAGE_PIN V5 IOSTANDARD LVCMOS33} [get_ports {MOT_X_BRK}];  # Brake Signal
